    ...
    return (
        <ul className="w-28 bg-white relative border p-2 rounded-lg shadow-md">
            <li className={liStyle}>
                <span className='text-xs text-[#1E1E1E] ml-2'><AiOutlineClose /></span>
                <p className='text-xs'>حذف</p>
            </li>

            <li className={liStyle}>
                <span className='text-xs text-[#1E1E1E] ml-2'><SlNote /></span>
                <p className='text-xs'>ویرایش تگ</p>
            </li>

            <li className={liStyle} onClick={()=> setColorModal(!colorModal)}>
                <span className='text-xs text-[#1E1E1E] ml-2'><VscSymbolColor /></span>
