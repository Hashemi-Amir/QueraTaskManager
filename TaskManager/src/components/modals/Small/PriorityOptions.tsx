...
const PriorityOptions = ({
  ...
  const liStyle =
    "w-full flex items-center px-3 mt-4 text-sm font-normal text-[#1E1E1E] cursor-pointer";
  const spanStyle = "text-xl ml-3 pointer-events-none";
  return (
    <ul
      className={`absolute  -right-44 -top-20 pb-3 w-44  bg-white z-50 rounded-lg shadow-lg ${className}`}
    >
      <li
        className={liStyle}
      ...
      >
        <span className={`${spanStyle} text-FB0606`}>
          <FiFlag />
        </span>
        فوری
      </li>
      ...
      <li
        ...
        onClick={(e) => handlePriority(e)}
      >
        <span className={`${spanStyle} text-FFE605`}>
          <FiFlag />
        </span>
        بالا
      </li>
      ...
      <li
        ...
        onClick={(e) => handlePriority(e)}
      >
        <span className={`${spanStyle} text-09DBCE`}>
          <FiFlag />
        </span>
        متوسط
      </li>
      ...
      <li
        ...
        onClick={(e) => handlePriority(e)}
      >
        <span className={`${spanStyle} text-[#B2ACAC]`}>
          <FiFlag />
        </span>
        پایین
      </li>
