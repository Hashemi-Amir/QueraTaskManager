...
const QuckCalendar = () => {
    ...
    return (
        <>
            ...
            <input 
                type="checkbox" id="my-modal" className="modal-toggle" 
            />
                ...
                <div className="modal-box p-0 max-w-4xl h-5/6 rounded-3xl shadow-[0_12px_32px_rgba(0,0,0,0.25)]">
                    ...
                    <div className="w-full flex justify-end pl-8">
                        <div className="w-32 h-8">
                            <label htmlFor="my-modal" className="w-full h-10 p-2.5 text-sm font-bold leading-4 cursor-pointer flex justify-center items-center text-white rounded-md bg-208D8E">بستن</label>
                        </div>
                    </div>
                </div>
